...
cmd_run()      { _parse_args "$@"; echo "gpu: placeholder, nothing to run"; }
cmd_evaluate() { _parse_args "$@"; echo "gpu: placeholder, nothing to evaluate"; }
cmd_cleanup()  { _parse_args "$@"; echo "gpu: placeholder, nothing to cleanup"; }
